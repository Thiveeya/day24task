      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
            ...
            <div className="nav-box">
                ...
                <a className="nav-name" onClick={()=>history.push("/")} href="/1">Dashboard</a>
            </div>
            <hr/>
            <div className="nav-box">
            ...
            <div className="nav-box">
                ...
                <a className="nav-name" onClick={()=>history.push("/charts")} href="/2">Charts</a>
            </div>
            <div className="nav-box">
                <i className="icon-nav"><BiTable/></i>
                <a className="nav-name" onClick={()=>history.push("/tables")} href="/3">Tables</a>
            </div>
            <hr/>
        </Navbar.Collapse>
      </Container>
